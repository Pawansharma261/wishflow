...
import { Sparkles, Calendar, Users, MessageSquare, Bell, Repeat, Star, ChevronRight, Camera, Phone, Shield, Zap, Heart, Gift, ArrowRight, Check, Menu, X } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    desc: 'Reach your loved ones wherever they are — WhatsApp, Camera DM, or push notifications, all from one place.',
    bg: 'bg-violet-50',
  },
  {
  ...
  },
  {
    ...
    desc: 'Organize all your contacts with their special dates, phone numbers, and Camera handles in one beautiful dashboard.',
    bg: 'bg-green-50',
  },
  {
...
const steps = [
  ...
  { emoji: '📲', title: 'Choose Channel', desc: 'Select WhatsApp, Camera DM, or push notifications — or all three at once.' },
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-500 font-medium mb-10 max-w-2xl mx-auto leading-relaxed">
            WishFlow automatically sends heartfelt wishes to your loved ones on WhatsApp and Camera — on birthdays, anniversaries, festivals, and every special occasion. Set it once, celebrate forever.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-slate-500">
            {['Free to start', 'No credit card', 'Works with WhatsApp', 'Camera DM'].map(item => (
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { icon: '📸', name: 'Camera DM', desc: 'Reach contacts through their Camera inbox automatically', color: 'bg-pink-500/20 border-pink-500/30' },
