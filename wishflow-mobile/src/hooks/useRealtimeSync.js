  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
           console.log('[Realtime:Mobile] User change:', payload.eventType);
      ...
      .on(
        ...
        (payload) => {
           console.log('[Realtime:Mobile] Contacts change:', payload.eventType);
      ...
      .on(
        ...
        (payload) => {
           console.log('[Realtime:Mobile] Wishes change:', payload.eventType);
